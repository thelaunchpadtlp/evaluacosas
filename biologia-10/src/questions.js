...
export const mepMapByQuestion = {
   1: { eje: "Eje I", subtema: "1.1 La Biología como ciencia · método científico", concepts: ["objeto de estudio", "observación", "hipótesis", "evidencia"] },
   2: { eje: "Eje I", subtema: "1.1 Diseño de investigación biológica · método científico aplicado", concepts: ["pregunta investigable", "hipótesis", "variables", "control"] },
   3: { eje: "Eje I", subtema: "1.2 Adaptación biológica · proceso evolutivo poblacional", concepts: ["adaptación", "rasgo heredable", "supervivencia", "reproducción"] },
   4: { eje: "Eje I", subtema: "1.2 Tipos de adaptación · morfológica, fisiológica, conductual", concepts: ["morfología", "fisiología", "etología"] },
   5: { eje: "Eje I", subtema: "1.2 Adaptaciones en animales tropicales · presiones selectivas", concepts: ["presión ambiental", "depredación", "alimentación", "clima"] },
   6: { eje: "Eje I", subtema: "1.2 Adaptaciones en plantas · respuesta a luz, agua, herbívoros", concepts: ["fotosíntesis adaptativa", "cutícula", "espinas", "metabolismo secundario"] },
   7: { eje: "Eje I", subtema: "1.3 Factores ambientales · climáticos, energéticos, sustrato", concepts: ["clima", "energía", "sustrato", "distribución"] },
   8: { eje: "Eje I", subtema: "1.4 Niveles de organización ecológica · especie, población, comunidad", concepts: ["especie", "población", "comunidad", "ecosistema"] },
   9: { eje: "Eje I", subtema: "1.5 Hábitat y nicho ecológico · diferenciación funcional", concepts: ["hábitat", "nicho", "rol funcional", "interacciones"] },
  10: { eje: "Eje I", subtema: "1.5 Relación recíproca organismo–ambiente", concepts: ["modificación del ambiente", "factor limitante", "interdependencia"] },
  11: { eje: "Eje I", subtema: "1.6 Interacciones ecológicas · mutualismo, competencia, depredación", concepts: ["mutualismo", "competencia", "depredación", "parasitismo"] },
  12: { eje: "Eje I", subtema: "1.6 Depredador–presa · regulación de comunidades", concepts: ["control de poblaciones", "diversidad alfa", "cascada trófica"] },
  13: { eje: "Eje I", subtema: "1.7 Capacidad de carga · factores limitantes", concepts: ["capacidad de carga", "factor limitante", "densidad poblacional"] },
  14: { eje: "Eje I", subtema: "1.8 Biodiversidad · niveles genético, específico, ecosistémico", concepts: ["diversidad genética", "diversidad específica", "diversidad ecosistémica"] },
  15: { eje: "Eje I", subtema: "1.8 Diversidad alfa, beta y gamma · escalas espaciales", concepts: ["diversidad α", "diversidad β", "diversidad γ"] },
  16: { eje: "Eje I", subtema: "1.8 Índices de biodiversidad · Shannon, Simpson", concepts: ["índice Shannon", "índice Simpson", "salud del ecosistema"] },
  17: { eje: "Eje I", subtema: "1.9 Endemismo · especies endémicas y conservación", concepts: ["endemismo", "rango limitado", "vulnerabilidad"] },
  18: { eje: "Eje I", subtema: "1.9 Megadiversidad costarricense · contexto biogeográfico", concepts: ["megadiversidad", "puente biogeográfico", "responsabilidad de conservación"] },
  19: { eje: "Eje I", subtema: "1.11 Servicios ecosistémicos · beneficios para comunidades humanas", concepts: ["servicios de provisión", "regulación", "culturales"] },
  20: { eje: "Eje I", subtema: "1.10 Amenazas a la biodiversidad · acción ciudadana local", concepts: ["amenaza local", "acción reductora", "comunidad"] },
  21: { eje: "Eje I", subtema: "1.10 Fragmentación del hábitat · conectividad ecológica", concepts: ["fragmentación", "conectividad", "extinción local"] },
  22: { eje: "Eje I", subtema: "1.9 Corredores biológicos · conectividad de paisaje", concepts: ["corredor biológico", "conectividad", "flujo de especies"] },
  23: { eje: "Eje I", subtema: "1.10 Especies invasoras · alteración de ecosistemas nativos", concepts: ["especie invasora", "competencia desplazante", "cascada de impactos"] },
  24: { eje: "Eje I", subtema: "1.9 Áreas protegidas y SINAC · marco institucional CR", concepts: ["áreas protegidas", "SINAC", "categorías de manejo"] },
  25: { eje: "Eje I", subtema: "1.13 Biomas y ecosistemas costarricenses · diversidad regional", concepts: ["bosque húmedo", "bosque seco", "manglar", "páramo", "arrecife"] },
  26: { eje: "Eje I", subtema: "1.11 Manglares · funciones ecosistémicas múltiples", concepts: ["manglar", "vivero pesquero", "protección costera", "captura de carbono"] },
  27: { eje: "Eje I", subtema: "1.12 Diseño experimental · variable independiente, control", concepts: ["variable independiente", "variable dependiente", "control", "réplicas"] },
  28: { eje: "Eje II", subtema: "2.1 Estructura y replicación del ADN · base de la herencia", concepts: ["nucleótidos", "doble hélice", "replicación semiconservativa"] },
  29: { eje: "Eje II", subtema: "2.2 Dogma central · transcripción y traducción", concepts: ["transcripción", "traducción", "ARN mensajero"] },
  30: { eje: "Eje II", subtema: "2.3 Leyes de Mendel · segregación e independencia", concepts: ["segregación", "distribución independiente", "dominancia"] },
  31: { eje: "Eje II", subtema: "2.4 Genotipo y fenotipo · interacción gen–ambiente", concepts: ["genotipo", "fenotipo", "expresión condicional"] },
  32: { eje: "Eje II", subtema: "2.5 Cruce monohíbrido · proporciones genotípicas y fenotípicas", concepts: ["cruce monohíbrido", "proporción 3:1", "cuadro de Punnett"] },
  33: { eje: "Eje II", subtema: "2.5 Cruce dihíbrido · distribución independiente", concepts: ["cruce dihíbrido", "proporción 9:3:3:1", "ligamento"] },
  34: { eje: "Eje II", subtema: "2.6 Herencia dominante y recesiva · homocigoto/heterocigoto", concepts: ["dominante", "recesivo", "homocigoto", "heterocigoto"] },
  35: { eje: "Eje II", subtema: "2.7 Herencia ligada al sexo · cromosomas X/Y", concepts: ["cromosoma X", "cromosoma Y", "rasgo recesivo ligado", "hemicigosis"] },
  36: { eje: "Eje II", subtema: "2.8 Codominancia y dominancia incompleta", concepts: ["codominancia", "dominancia incompleta", "fenotipo intermedio"] },
  37: { eje: "Eje II", subtema: "2.9 Herencia poligénica · variación continua", concepts: ["poligenia", "variación continua", "distribución normal"] },
  38: { eje: "Eje II", subtema: "2.10 Meiosis · fuente de variabilidad", concepts: ["meiosis", "recombinación", "segregación independiente"] },
  39: { eje: "Eje II", subtema: "2.11 Mutaciones · fuente primaria de variación", concepts: ["mutación", "neutra/deletérea/beneficiosa", "selección"] },
  40: { eje: "Eje II", subtema: "2.11 Tipos de mutación · puntuales y cromosómicas", concepts: ["mutación puntual", "mutación cromosómica", "deleción", "translocación"] },
  41: { eje: "Eje II", subtema: "2.12 Enfermedades genéticas · gen, mutación, patrón", concepts: ["enfermedad genética", "patrón hereditario", "diagnóstico molecular"] },
  42: { eje: "Eje II", subtema: "2.13 Código genético · universalidad y origen común", concepts: ["código genético", "universalidad", "evidencia evolutiva"] },
  43: { eje: "Eje II", subtema: "2.14 Proyecto Genoma Humano · ciencia, descubrimientos, ética", concepts: ["genoma humano", "secuenciación", "dilemas éticos"] },
  44: { eje: "Eje II", subtema: "2.15 Biotecnología moderna vs tradicional", concepts: ["ingeniería genética", "biotecnología tradicional", "ADN recombinante"] },
  45: { eje: "Eje II", subtema: "2.15 ADN recombinante · enzimas de restricción, ligasa, plásmidos", concepts: ["enzimas de restricción", "ADN ligasa", "plásmido", "vector"] },
  46: { eje: "Eje II", subtema: "2.15 PCR y electroforesis · identificación de ADN", concepts: ["PCR", "electroforesis", "huella genética"] },
  47: { eje: "Eje II", subtema: "2.15 OGM en agricultura · ventajas y preocupaciones", concepts: ["OGM", "transgénesis", "regulación", "biodiversidad agrícola"] },
  48: { eje: "Eje II", subtema: "2.16 Clonación reproductiva vs terapéutica · caso Dolly", concepts: ["clonación reproductiva", "clonación terapéutica", "células somáticas"] },
  49: { eje: "Eje II", subtema: "2.17 Terapia génica somática vs edición germinal", concepts: ["terapia somática", "edición germinal", "consentimiento informado"] },
  50: { eje: "Eje II", subtema: "2.17 CRISPR-Cas9 · edición precisa y bioética", concepts: ["CRISPR", "Cas9", "ARN guía", "dilemas éticos"] },
  51: { eje: "Eje II", subtema: "2.18 Aplicaciones médicas · insulina recombinante, ARN, anticuerpos", concepts: ["insulina recombinante", "vacunas ARN", "anticuerpos monoclonales"] },
  52: { eje: "Eje II", subtema: "2.19 Epigenética · regulación sin cambio de secuencia", concepts: ["epigenética", "metilación", "regulación de la expresión"] },
  53: { eje: "Eje II", subtema: "2.19 Interferencia de ARN · regulación post-transcripcional", concepts: ["ARNi", "siRNA", "miRNA", "potencial terapéutico"] },
  54: { eje: "Eje II", subtema: "2.20 Bioética en manipulación genética humana", concepts: ["bioética", "derechos", "regulación", "proporcionalidad de riesgo"] },
  55: { eje: "Eje III", subtema: "3.1 Síntesis prebiótica · Oparin–Haldane", concepts: ["sopa primigenia", "atmósfera reductora", "monómeros orgánicos"] },
  56: { eje: "Eje III", subtema: "3.1 Experimento Miller–Urey · evidencia y límites", concepts: ["Miller-Urey", "aminoácidos abióticos", "límites del modelo"] },
  57: { eje: "Eje III", subtema: "3.2 Otras teorías del origen · panspermia, hidrotermal, mundo ARN", concepts: ["panspermia", "fumarolas hidrotermales", "mundo ARN"] },
  58: { eje: "Eje III", subtema: "3.3 Escala del tiempo geológico · eras y periodos", concepts: ["era", "periodo", "edad", "evolución temporal"] },
  59: { eje: "Eje III", subtema: "3.4 Lamarck vs Darwin · mecanismos evolutivos", concepts: ["Lamarck", "Darwin", "uso/desuso", "selección natural"] },
  60: { eje: "Eje III", subtema: "3.5 Selección natural · variación heredable preexistente", concepts: ["variación heredable", "presión selectiva", "fitness"] },
  61: { eje: "Eje III", subtema: "3.6 Evidencias paleontológicas · registro fósil", concepts: ["fósil", "estratigrafía", "transición evolutiva"] },
  62: { eje: "Eje III", subtema: "3.6 Evidencias anatómicas · homologías, analogías, vestigios", concepts: ["homología", "analogía", "estructura vestigial"] },
  63: { eje: "Eje III", subtema: "3.6 Evidencia biogeográfica · distribución de especies", concepts: ["biogeografía", "distribución", "barreras geográficas"] },
  64: { eje: "Eje III", subtema: "3.6 Evidencia molecular y embriológica · origen común", concepts: ["filogenia molecular", "embriología comparada", "ontogenia"] },
  65: { eje: "Eje III", subtema: "3.7 Evolución convergente vs divergente", concepts: ["convergencia", "divergencia", "presión similar/distinta"] },
  66: { eje: "Eje III", subtema: "3.8 Aislamiento reproductivo · pre/poscigótico", concepts: ["precigótico", "poscigótico", "esterilidad híbrida"] },
  67: { eje: "Eje III", subtema: "3.9 Radiación adaptativa · pinzones de Darwin", concepts: ["radiación adaptativa", "diversificación rápida", "nichos vacantes"] },
  68: { eje: "Eje III", subtema: "3.10 Deriva genética vs selección natural", concepts: ["deriva", "selección", "azar", "fitness"] },
  69: { eje: "Eje III", subtema: "3.11 Efecto fundador y cuello de botella · casos de deriva", concepts: ["efecto fundador", "cuello de botella", "frecuencia alélica"] },
  70: { eje: "Eje III", subtema: "3.10 Flujo génico · entre poblaciones", concepts: ["flujo génico", "polen", "migración", "homogeneización"] },
  71: { eje: "Eje III", subtema: "3.12 Selección sexual · rasgos costosos", concepts: ["selección sexual", "dimorfismo", "elección de pareja"] },
  72: { eje: "Eje III", subtema: "3.13 Tipos de selección · estabilizadora, direccional, disruptiva", concepts: ["estabilizadora", "direccional", "disruptiva"] },
  73: { eje: "Eje III", subtema: "3.14 Síntesis moderna · neodarwinismo", concepts: ["genética de poblaciones", "Hardy-Weinberg", "síntesis moderna"] },
  74: { eje: "Eje III", subtema: "3.15 Coevolución · interacciones evolutivas", concepts: ["coevolución", "polinización", "depredador-presa"] },
  75: { eje: "Eje III", subtema: "3.16 Endosimbiosis · origen de eucariotas", concepts: ["endosimbiosis", "mitocondria", "cloroplasto", "Margulis"] },
  76: { eje: "Eje III", subtema: "3.17 Filogenia · árboles y cladogramas", concepts: ["filogenia", "cladograma", "carácter derivado"] },
  77: { eje: "Eje III", subtema: "3.18 Extinciones masivas · K-Pg y consecuencias", concepts: ["extinción masiva", "K-Pg", "radiación post-extinción"] },
  78: { eje: "Eje III", subtema: "3.19 Resistencia antibiótica · selección en tiempo real", concepts: ["resistencia antibiótica", "presión selectiva", "tiempo evolutivo corto"] },
  79: { eje: "Eje III", subtema: "3.20 Impacto humano · diversificación y extinción", concepts: ["antropoceno", "tasa de extinción", "fragmentación"] },
  80: { eje: "Eje III", subtema: "3.5 + 3.10 + 3.11 (integrador) · diversidad de especies multifactorial", concepts: ["mutación", "recombinación", "selección", "deriva", "flujo génico"] }
};
